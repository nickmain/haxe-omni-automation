...
extern class Document {
    static function makeNew(resultFunction: Null<(Dynamic) -> Void>): js.lib.Promise<omni.graffle.Document>;
    static function makeNewAndShow(resultFunction: Null<(Dynamic) -> Void>): js.lib.Promise<omni.graffle.Document>;
