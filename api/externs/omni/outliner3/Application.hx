...
extern class Application {
    ...
    function openDocument(from: Null<omni.outliner.Document>, url: omni.outliner.URL, completed: (documentOrError: epistem.typescript.Helpers.Union2<omni.outliner.Document, js.lib.Error>, alreadyOpen: Bool) -> Void): Void;
}
