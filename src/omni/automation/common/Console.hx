...
extern class Console {
    ...
    static function log(message: Dynamic, additional: Null<Array<Dynamic>>): Void;

    static function error(message: Dynamic, additional: Null<Array<Dynamic>>): Void;

    static function info(message: Dynamic, additional: Null<Array<Dynamic>>): Void;

    // Just calls Console.log, currently.
    static function warn(message: Dynamic, additional: Null<Array<Dynamic>>): Void;
