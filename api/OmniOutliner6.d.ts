// TypeScript definitions for OmniOutliner 6 (220.0.746) on macOS 15.6.1
// Generated on 2025-11-04 23:37:23 +0000
...
declare class Document {
    ...
    createOmniLinkURL(additionalQueryItems: Array<URL.QueryItem> | null, additionalPromptMessage: string | null): Promise<URL>;
...
declare namespace LanguageModel {
    class Session {
        ...
        respondWithSchema(prompt: string, schema: LanguageModel.Schema, generationOptions: LanguageModel.GenerationOptions | null): Promise<string>;
    }
}
...
declare class Outline {
    ...
    invertColors(): void;
    enableDynamicThemingUsingCurrentColorsForDarkMode(useCurrentColorsForDarkMode: boolean): void;
    disableDynamicTheming(retainDarkModeColors: boolean): void;
    ...
    readonly dynamicThemingEnabled: boolean;
