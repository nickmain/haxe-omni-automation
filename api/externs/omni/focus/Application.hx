...
extern class Application {
    ...
    function openDocument(from: Null<omni.focus.Document>, url: omni.focus.URL, completed: (epistem.typescript.Helpers.Union2<omni.focus.Document, js.lib.Error>, Bool) -> Void): Void;
}
