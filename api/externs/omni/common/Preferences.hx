...
extern class Preferences {
    ...
    function readData(key: String): Null<omni.common.Data>;
    function write(key: String, value: Null<epistem.typescript.Helpers.Union5<Bool, String, Float, js.lib.Date, omni.common.Data>>): Void;
