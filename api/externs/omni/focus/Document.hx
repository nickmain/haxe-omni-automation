...
extern class Document {
    static function makeNew(resultFunction: Null<js.lib.Function>): js.lib.Promise<omni.focus.Document>;
    static function makeNewAndShow(resultFunction: Null<js.lib.Function>): js.lib.Promise<omni.focus.Document>;
