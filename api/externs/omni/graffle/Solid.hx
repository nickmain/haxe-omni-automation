...
extern class Solid extends Graphic {
    ...
    var imagePage: Float;
    var imageScale: omni.graffle.Size;
    var imageSizing: omni.graffle.ImageSizing;
    ...
    var textSize: Float;
    var textUnitRect: omni.graffle.Rect;
    var textVerticalPadding: Float;
    var textVerticalPlacement: omni.graffle.VerticalTextPlacement;
    var textWraps: Bool;
